#!/bin/bash
#SBATCH --job-name=cod_llama3_json
...
python /home/sc.uni-leipzig.de/ag52peve/dev/math-ml/pipeline.py --experiment_name="cod_test_json_llama3" --n_samples=20 --start_index=0 --model_name="meta-llama/Meta-Llama-3-8B" --device="cuda" --tokens_per_response=1000 --prompting_technique="cod" --rerun_buggy_samples="no"
