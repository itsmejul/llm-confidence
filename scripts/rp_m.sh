#!/bin/bash
#SBATCH --job-name=llama3_baseline_100
...
python /home/sc.uni-leipzig.de/ag52peve/dev/math-ml/pipeline.py --experiment_name="baseline_llama3_100" --n_samples=100 --start_index=0 --model_name="meta-llama/Meta-Llama-3-8B" --device="cuda" --tokens_per_response=40 --prompting_technique="baseline" --rerun_buggy_samples="no"
