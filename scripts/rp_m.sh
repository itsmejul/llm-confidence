#!/bin/bash
#SBATCH --job-name=qwen_reasoning_10_5
...
python /home/sc.uni-leipzig.de/ag52peve/dev/math-ml/pipeline.py --n_samples=10 --model_name=Qwen/Qwen3-8B --device=cuda --tokens_per_response=1000 --reasoning_qwen --not_verbose
