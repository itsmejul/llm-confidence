...
python /home/sc.uni-leipzig.de/ag52peve/dev/math-ml/pipeline.py --experiment_name="cot_test_json_qwen" --n_samples=10 --start_index=0 --model_name="Qwen/Qwen3-8B" --device="cuda" --tokens_per_response=1000 --prompting_technique="cot" --rerun_buggy_samples="no"
