#!/bin/bash
#SBATCH --job-name=qwen_noreasoning_100
...
python /home/sc.uni-leipzig.de/ag52peve/dev/math-ml/pipeline.py --n_samples=100 --model_name=Qwen/Qwen3-8B --device=cuda --tokens_per_response=50 --no_reasoning_qwen --not_verbose
