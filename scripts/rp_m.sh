#!/bin/bash
#SBATCH --job-name=rerun_qwen_baseline
...
python /home/sc.uni-leipzig.de/ag52peve/dev/math-ml/accuracy/pipeline.py --experiment_name="all_baseline_qwen" --n_samples=-1 --start_index=0 --model_name="Qwen/Qwen3-8B" --device="cuda" --tokens_per_response=30 --prompting_technique="baseline" --rerun_buggy_samples="yes"
