...
if rerun_buggy_samples == "no":
    ...
    #buggy_csv_path = os.path.join("experiments", experiment_name, "buggy_prompts_to_rerun.csv") #TODO path
    buggy_csv_path = os.path.join("results", "accuracy_exp", experiment_name, "buggy_prompts_to_rerun.csv")
...
if __name__ == "__main__":
    ...
    #dir_path = os.path.join("experiments", experiment_name) #TODO path
    dir_path = os.path.join("results", "accuracy_exp", experiment_name)
