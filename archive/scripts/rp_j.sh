...
python /home/sc.uni-leipzig.de/gr15iped/dev/math-ml/pipeline.py --experiment_name="llama2_cod_all" --n_samples=-1 --start_index=0 --model_name="meta-llama/Llama-3.1-8B" --device="cuda" --tokens_per_response=1000 --prompting_technique="cod" --rerun_buggy_samples="yes"
